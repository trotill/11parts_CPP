/*
 example:
    #include "engine/lib/mustache/mustache.hpp"

	string html;
	ReadStringFile((char*)template_file.c_str(),html);

	kainjow::mustache::mustache tmpl{html};
	kainjow::mustache::object context={{"report","Report"},{"controlled_system", "Controlled system"}};
